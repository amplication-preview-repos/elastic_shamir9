...
const CREATE_INPUT = {
  ...
  id: "exampleId",
  lga: "exampleLga",
  lgaOfResidence: "exampleLgaOfResidence",
  phoneNumber: "examplePhoneNumber",
  residentialAddress: "exampleResidentialAddress",
  stateOfOrigin: "exampleStateOfOrigin",
  stateOfResidence: "exampleStateOfResidence",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
